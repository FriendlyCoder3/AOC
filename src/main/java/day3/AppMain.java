...
public class AppMain {
    ...
    public static Set<Position> getVisitedCombined(String pathInput){
        char[] path = pathInput.toCharArray();
        Set<Position> visited = new HashSet<Position>();
        Position santa = new Position(0,0), rudolph = new Position(0,0);
        visited.add(santa);
        for(int i = 0; i<path.length-1; i+=2){
            santa =  santa.getNewPosition(path[i]);
            rudolph = rudolph.getNewPosition(path[i+1]);
            visited.add(santa);
            visited.add(rudolph);
        }
    ...
    public static Set<Position> getVisited(String pathInput){
        char[] path = pathInput.toCharArray();
        ...
        for(char c: path){
            current = current.getNewPosition(c);
            visited.add(current);
        }
    ...
    public static void showPathCombined(String path){
        Set<Position> visited = getVisitedCombined(path);
        System.out.println(path);
        showPositions(visited);
        System.out.println(path + " : "  + visited.size());
        System.out.println("-----------------------------------");
    }
    public static void showPath(String path){
        Set<Position> visited = getVisited(path);
        System.out.println(path);
        showPositions(visited);
        printComputed(path);
        System.out.println("-----------------------------------");
    ...
    public static void showPositions(Set<Position> visited){
    ...
    public static void printComputed(String path){
        System.out.println(path + " : " + getVisitedHouses(path));

    }

    public static int getVisitedHouses(String path){
        return getVisited(path).size();
    }
...
//        showPath("^v^v^v^v^v");
        ...
        showPathCombined("^v");
        showPathCombined("^>v<");
        showPathCombined("^v^v^v^v^v");



        int visitedHouses = getVisitedHouses(input);
        System.out.println("only santa: " +  visitedHouses);


        int visitedCombined = getVisitedCombined(input).size();
        System.out.println("both: " + visitedCombined );
